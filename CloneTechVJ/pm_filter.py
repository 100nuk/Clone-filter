...
async def advantage_spell_chok(client, name, msg, reply_msg, KK_search):
    mv_id = msg.id
    mv_rqst = name
    ...
    if vj_search == True:
        vj_search_new = False
        vj_ai_msg = await reply_msg.edit_text("<b><i>Advance Ai Of Tech KK Try To Find Your Movie With Your Wrong Spelling.</i></b>")
        movienamelist = []
